...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Мова"),
        ("Keep HelpDesk background service", "Захаваць фонавую службу RustDesk"),
        ...
        ("Show HelpDesk", "Паказаць RustDesk"),
        ...
        ("verify_helpdesk_password_tip", "Пацвердзіць пароль RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Абнавіце RustDesk Server Pro да версіі {} або новейшай!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Калі ласка, абнавіце кліент RustDesk да версіі {} або навейшай на аддаленым баку!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
