...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "꺼짐"),
        ("Language", "언어"),
        ("Keep HelpDesk background service", "RustDesk 백그라운드 서비스 유지"),
        ...
        ("verify_helpdesk_password_tip", "RustDesk 비밀번호 확인"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "RustDesk Server Pro를 {} 버전 이상으로 업그레이드하세요!"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "RustDesk 클라이언트를 원격 버전 {} 이상으로 업그레이드해 주세요!"),
