...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Γλώσσα"),
        ("Keep HelpDesk background service", "Διατήρηση της υπηρεσίας παρασκηνίου του RustDesk"),
        ...
        ("Show HelpDesk", "Εμφάνιση του RustDesk"),
        ...
        ("verify_helpdesk_password_tip", "Επιβεβαιώστε τον κωδικό του RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε το RustDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("About HelpDesk", "Πληροφορίες για το RustDesk"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη RustDesk στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
