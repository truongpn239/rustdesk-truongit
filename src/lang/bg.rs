...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Език"),
        ("Keep HelpDesk background service", "Запази RustDesk фоновата услуга"),
        ...
        ("verify_helpdesk_password_tip", "Проверете RustDesk паролата"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Моля обновете RustDesk Server Pro на версия {} или по-нова!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Моля, надстройте клиента RustDesk до версия {} или по-нова от отдалечената страна!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
