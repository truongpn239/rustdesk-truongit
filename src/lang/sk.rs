...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep HelpDesk background service", "Ponechať službu RustDesk na pozadí"),
        ...
        ("Show HelpDesk", "Zobraziť RustDesk"),
        ...
        ("verify_helpdesk_password_tip", "Overenie hesla RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Aktualizujte RustDesk Server Pro na verziu {} alebo novšiu!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Aktualizujte klienta RustDesk na verziu {} alebo novšiu na vzdialenej strane!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
