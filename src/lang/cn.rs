...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep HelpDesk background service", "保持 RustDesk 后台服务"),
        ...
        ("verify_helpdesk_password_tip", "验证 RustDesk 密码"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "请升级专业版服务器到{}或更高版本！"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "请在远程端将 RustDesk 客户端升级至版本 {} 或更新版本！"),
