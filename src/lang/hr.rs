...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Jezik"),
        ("Keep HelpDesk background service", "Zadrži RustDesk kao pozadinski servis"),
        ...
        ("verify_helpdesk_password_tip", "Provjera lozinke za RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Ažurirajte RustDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Molimo ažurirajte RustDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
