...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep HelpDesk background service", "Saglabāt RustDesk fona servisu"),
        ...
        ("verify_helpdesk_password_tip", "Pārbaudīt RustDesk paroli"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Lūdzu, jauniniet RustDesk Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Lūdzu, jauniniet attālās puses RustDesk klientu uz versiju {} vai jaunāku!"),
