...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای HelpDesk برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز HelpDesk برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز HelpDesk برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی HelpDesk شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"HelpDesk Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep HelpDesk background service", "را در پس زمینه نگه دارید HelpDesk سرویس"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز HelpDesk \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. HelpDesk \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای HelpDesk کلیک کند."),
        ...
        ("verify_helpdesk_password_tip", "رمز عبور HelpDesk را تأیید کنید"),
        ...
        ("scam_text1", "استفاده کنید و سرویس را راه‌اندازی کنید، صحبت می‌کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید HelpDesk اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید و از شما خواسته است از"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید HelpDesk Server Pro لظفا"),
        ...
        ("selinux_tip", "به عنوان کنترل شده جلوگیری کند HelpDesk روی دستگاه شما فعال است ، که ممکن است از اجرای صحیح SELinux"),
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود HelpDesk زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند HelpDesk این به حفظ سرویس پس زمینه"),
        ...
        ("About HelpDesk", "HelpDesk درباره"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "لطفاً HelpDesk را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ...
        ("allow-insecure-tls-fallback-tip", "به‌طور پیش‌فرض، HelpDesk گواهی سرور را برای پروتکل‌ها با استفاده از TLS تأیید می‌کند.\nبا فعال بودن این گزینه، HelpDesk دوباره مرحله تأیید را رد می‌کند و در صورت عدم موفقیت تأیید ادامه می‌دهد."),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، HelpDesk دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور HelpDesk OSS این ویژگی را ندارد."),
