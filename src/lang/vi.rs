...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Email", "Email"),
        ("Username missed", "Vui lòng nhập tên đăng nhập"),
        ("Password missed", "Vui lòng nhập mật khẩu"),
        ("hardware_id_missing", "Không lấy được Hardware ID"),
        ...
        ("install_tip", "Do cơ chế UAC, HelpDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt HelpDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho HelpDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho HelpDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [HelpDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep HelpDesk background service", "Giữ dịch vụ HelpDesk chạy nền"),
        ...
        ("verify_helpdesk_password_tip", "Xác thực mật khẩu HelpDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng HelpDesk với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ HelpDesk mở"),
        ...
        ("floating_window_tip", "Giữ HelpDesk trên cùng"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
