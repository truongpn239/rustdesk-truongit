...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Nyelv"),
        ("Keep HelpDesk background service", "RustDesk futtatása a háttérben"),
        ...
        ("Show HelpDesk", "A RustDesk megjelenítése"),
        ...
        ("verify_helpdesk_password_tip", "RustDesk jelszó megerősítése"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Frissítse a RustDesk Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("About HelpDesk", "A RustDesk névjegye"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Frissítse a RustDesk klienst {} vagy újabb verziójára a távoli oldalon!"),
