...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep HelpDesk background service", "Rulează serviciul RustDesk în fundal"),
        ...
        ("Show HelpDesk", "Afișează RustDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("verify_helpdesk_password_tip", "Verifică parola RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_{}_tip", "Versiunea serverului RustDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("About HelpDesk", "Despre RustDesk"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Versiunea clientului RustDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
