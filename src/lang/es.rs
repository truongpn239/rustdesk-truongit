...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep HelpDesk background service", "Dejar RustDesk como Servicio en 2do plano"),
        ...
        ("Show HelpDesk", "Mostrar RustDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("verify_helpdesk_password_tip", "Verificar la contraseña de RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "¡Por favor, actualiza RustDesk Server Pro a la versión {} o superior"),
        ...
        ("About HelpDesk", "Acerca de RustDesk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Por favor, actualiza el cliente RustDesk a la versión {} o superior en el lado remoto"),
