...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Keel"),
        ("Keep HelpDesk background service", "Säilita RustDeski taustateenus"),
        ...
        ("verify_helpdesk_password_tip", "Kinnita RustDeski parool"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Palun täienda RustDesk Server Pro versioonile {} või uuem!"),
        ...
        ("About HelpDesk", "RustDeski teave"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Täiendage RustDeski klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
