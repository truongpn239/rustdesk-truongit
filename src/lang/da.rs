...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep HelpDesk background service", "Behold RustDesk baggrundstjeneste"),
        ...
        ("verify_helpdesk_password_tip", "Bekræft RustDesk adgangskode"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Opgradér venligst RustDesk Server Pro til version {} eller nyere!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Opgrader venligst RustDesk-klienten til version {} eller nyere på fjernsiden!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
