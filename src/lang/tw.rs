...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep HelpDesk background service", "保持 RustDesk 後台服務"),
        ...
        ("verify_helpdesk_password_tip", "驗證 RustDesk 密碼"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "請升級專業版伺服器到{}或更高版本！"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "請將遠端 RustDesk 客戶端升級到 {} 或更新版本！"),
