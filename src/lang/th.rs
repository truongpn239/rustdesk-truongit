...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "ปิด"),
        ("Language", "ภาษา"),
        ("Keep HelpDesk background service", "คงสถานะการทำงานเบื้องหลังของเซอร์วิส RustDesk"),
        ...
        ("verify_helpdesk_password_tip", "ยืนยันความถูกต้องรหัสผ่านของ RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "กรุณาอัปเดต RustDesk Server Pro ไปยังเวอร์ชัน {} หรือใหม่กว่า!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "กรุณาอัปเดต RustDesk ไคลเอนต์ไปยังเวอร์ชัน {} หรือใหม่กว่าที่ฝั่งปลายทาง!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
