...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "ენა"),
        ("Keep HelpDesk background service", "RustDesk-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show HelpDesk", "RustDesk-ის ჩვენება"),
        ...
        ("verify_helpdesk_password_tip", "დაადასტურეთ RustDesk-ის პაროლი"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "განაახლეთ RustDesk Server Pro ვერსიამდე {} ან უფრო ახალი!"),
        ...
        ("About HelpDesk", "RustDesk-ის შესახებ"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "განაახლეთ RustDesk კლიენტი ვერსიამდე {} ან უფრო ახალი დისტანციურ მხარეზე!"),
