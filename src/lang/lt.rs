...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep HelpDesk background service", "Palikti RustDesk fonine paslauga"),
        ...
        ("verify_helpdesk_password_tip", "Įveskite kliento RustDesk slaptažodį"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", ""),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės RustDesk klientą į {} ar naujesnę versiją!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
