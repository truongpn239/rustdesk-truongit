...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Kieli"),
        ("Keep HelpDesk background service", "Pidä RustDeskin taustapalvelu käynnissä"),
        ...
        ("verify_helpdesk_password_tip", "Vahvista RustDesk salasanasi kirjautumista varten"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Päivitä RustDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About HelpDesk", "Tietoa RustDeskistä"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Päivitä etä-RustDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
