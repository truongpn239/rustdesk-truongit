...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "மொழி"),
        ("Keep HelpDesk background service", "RustDesk பின்புல சேவையை வைத்திரு"),
        ...
        ("Show HelpDesk", "RustDesk ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("verify_helpdesk_password_tip", "rustdesk_கடவுச்சொல்_சரிபார்ப்பு_குறிப்பு"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "RustDesk Server Pro {} க்கு மேம்படுத்து"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "ரிமோட்_rustdesk_கிளையன்டை_{}_மேம்படுத்து_குறிப்பு"),
