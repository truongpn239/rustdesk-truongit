...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Idioma"),
        ("Keep HelpDesk background service", "Manté el servei del RustDesk en rerefons"),
        ...
        ("Show HelpDesk", "Mostra el RustDesk"),
        ...
        ("verify_helpdesk_password_tip", "Verifica la contrasenya del RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Actualitzeu el RustDesk Server Pro a la versió {} o superior!"),
        ...
        ("About HelpDesk", "Quant al RustDesk"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", ""),
        ("d3d_render_tip", ""),
