...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep HelpDesk background service", "ابق خدمة RustDesk تعمل في الخلفية"),
        ...
        ("verify_helpdesk_password_tip", "تحقق من كلمة مرور RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "ترقية خادم RustDesk Pro إلى {}"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "ترقية عميل RustDesk البعيد إلى {}"),
