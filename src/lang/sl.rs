...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Jezik"),
        ("Keep HelpDesk background service", "Ohrani RustDeskovo storitev v ozadju"),
        ...
        ("Show HelpDesk", "Prikaži RustDesk"),
        ...
        ("verify_helpdesk_password_tip", "Preveri geslo za RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Prosimo, nadgradite RustDesk Server Pro na različico {} ali novejšo."),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Prosimo, nadgradite RustDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
