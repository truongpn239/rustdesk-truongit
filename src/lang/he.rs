...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep HelpDesk background service", "השאר את שירות הרקע של RustDesk פעיל"),
        ...
        ("verify_helpdesk_password_tip", "אמת סיסמת RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "אנא שדרג את RustDesk Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "אנא שדרג את לקוח RustDesk לגרסה {} או חדשה יותר בצד המרוחק!"),
