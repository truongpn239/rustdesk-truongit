...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Langue"),
        ("Keep HelpDesk background service", "Garder le service RustDesk en arrière plan"),
        ...
        ("Show HelpDesk", "Afficher RustDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("verify_helpdesk_password_tip", "Vérifier le mot de passe RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Veuillez mettre à jour RustDesk Server Pro vers la version {} ou une version ultérieure !"),
        ...
        ("About HelpDesk", "À propos de RustDesk"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Veuillez mettre le client RustDesk distant à jour vers la version {} ou ultérieure !"),
