...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep HelpDesk background service", "Mantendu RustDesk atzeko planoko zerbitzu bezala"),
        ...
        ("Show HelpDesk", "Erakutsi RustDesk"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ("Elevate", "Igo maila"),
        ...
        ("verify_helpdesk_password_tip", "Berretsi RustDesk pasahitza"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu RustDesk Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Mesedez, eguneratu RustDesk bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
