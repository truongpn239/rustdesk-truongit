...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "ભાષા"),
        ("Keep HelpDesk background service", "RustDesk બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("verify_helpdesk_password_tip", "RustDesk પાસવર્ડ ચકાસો"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "સર્વર પ્રો ને {} માં અપગ્રેડ કરો"),
        ...
        ("upgrade_remote_helpdesk_client_to_{}_tip", "રિમોટ ક્લાયન્ટને {} માં અપગ્રેડ કરો"),
