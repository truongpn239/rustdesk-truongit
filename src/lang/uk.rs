...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Мова"),
        ("Keep HelpDesk background service", "Зберегти фонову службу RustDesk"),
        ...
        ("Show HelpDesk", "Показати RustDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("verify_helpdesk_password_tip", "Перевірте пароль RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Будь ласка, оновіть RustDesk Server Pro до версії {} чи новіше!"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Будь ласка, оновіть RustDesk клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
