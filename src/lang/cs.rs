...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep HelpDesk background service", "Zachovat službu RustDesk na pozadí"),
        ...
        ("Show HelpDesk", "Zobrazit RustDesk"),
        ...
        ("verify_helpdesk_password_tip", "Ověření hesla RustDesk"),
        ...
        ("upgrade_helpdesk_server_pro_to_{}_tip", "Aktualizujte prosím RustDesk Server Pro na verzi {} nebo novější!"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_helpdesk_client_to_{}_tip", "Upgradujte prosím klienta RustDesk na verzi {} nebo novější na vzdálené straně!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
